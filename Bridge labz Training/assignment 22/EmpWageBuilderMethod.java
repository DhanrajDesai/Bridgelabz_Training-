public class EmpWageBuilderMethod{
        ...
        private final int maxHoursPerMonth;
            ...
            public EmpWageBuilderMethod(String company, int empRatePerHour,int numOfWorkingDays,int maxHourPerMonth){
                ...
                public static void main(String []args)
                {
                        ...
                        EmpWageBuilderMethod bigBasket= new EmpWageBuilderMethod("bigBasket",10,2,7);
